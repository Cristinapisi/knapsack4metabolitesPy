...
CARBON = frozendict({'name': "carbon", 'symbol' : "C", 'mass': 12.01070000000, 'valence': 4, 'freqisotope': C12, 'isotopes': frozenset([C12, C13, C14])})
...
HYDROGEN = frozendict({'name': "hydrogen", 'symbol': "H", 'mass': 1.00794000000, 'valence': 1, 'freqisotope': H1, 'isotopes': frozenset([H1, H2, H3])})
...
NITROGEN = frozendict({'name': "nitrogen", 'symbol': "N", 'mass': 14.00670000000, 'valence': 3, 'freqisotope': N14, 'isotopes': frozenset([N14, N15])})
...
OXYGEN = frozendict({'name': "oxygen", 'symbol': "O", 'mass': 15.99940000000, 'valence': 2, 'freqisotope': O16, 'isotopes': frozenset([O16, O17, O18])})
CHNOPS.append(OXYGEN)

P31 = frozendict({'mass': 30.97376151200, 'percent': 100.0000})
PHOSPHORUS = frozendict({'name': "phosphor", 'symbol': "P", 'mass': 30.97376149000, 'valence': 3, 'freqisotope': P31, 'isotopes': frozenset([P31])})
...
SULFUR = frozendict({'name': "sulfur", 'symbol': "S", 'mass': 32.06533000000, 'valence': 2, 'freqisotope': S32, 'isotopes': frozenset([S32, S33, S34, S35, S36])})
...
CHLORINE = frozendict({'name': "chlorine", 'symbol': "Cl", 'mass': 35.45273000000, 'valence': 1, 'freqisotope': Cl35, 'isotopes': frozenset([Cl35, Cl36, Cl37])})
elements.append(CHLORINE)

F19 = frozendict({'mass': 18.99840320500, 'percent': 100.0000})
FLUORINE = frozendict({'name': 'fluorine', 'symbol': "F", 'mass': 18.99840325000, 'valence': 1, 'freqisotope': F19, 'isotopes': frozenset([F19])})
elements.append(FLUORINE)

Na23 = frozendict({'mass': 22.989770, 'percent': 100.0000})
NATRIUM = frozendict({'name': 'natrium', 'symbol': "Na", 'mass': 22.989770, 'valence': 1, 'freqisotope': Na23, 'isotopes': frozenset([Na23])})
elements.append(NATRIUM)

Br79 = frozendict({'mass': 78.9183376, 'percent': 50.69})
Br81 = frozendict({'mass': 80.9162910, 'percent': 49.31})
BROMINE = frozendict({'name': 'bromine', 'symbol': "Br", 'mass': 79.904, 'valence': 0, 'freqisotope': Br79, 'isotopes': frozenset([Br79, Br81])})
elements.append(BROMINE)

I127 = frozendict({'mass': 126.904468, 'percent': 100.0000})
IODINE = frozendict({'name': 'iodine', 'symbol': "I", 'mas': 126.90447, 'valence': 0, 'freqisotope': I127, 'isotopes': frozenset([I127])})
